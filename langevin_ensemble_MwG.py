...
def ensemble_step(args):
    ...
    ----------
    args: list
        RSGS_param, currentX, currentAlpha, currentSigma,
    ...
    acceptBool: Bool
    """
    RSGS_param, currentX, currentAlpha, currentSigma, otherX, otherAlpha, otherSigma, M_trunc, a_prop, omega, currentLogPost = args
...
def run_ensemble_sampler():
    ...
    for i in range(N):
        RSGS_param = "AIES" if (i%2==0) else "CS" # MwG: alternate AIES move and pCN on the CS
        mylist = list(range(L))
        ...
        for idxS in [0,1]:
            ...
            for k in S_current:
                ...
                arg_list = [RSGS_param, currentX[k,:], currentAlpha[k], currentSigma[k],
